...
from erpnext.accounts.report.item_wise_purchase_register.item_wise_purchase_register import apply_conditions, get_aii_accounts, get_purchase_receipts_against_purchase_order
...
def _execute(filters=None, additional_table_columns=None):
	...
	if filters.get("branch"):
		item_list = get_items(filters, additional_table_columns, filters.get("branch"))
	else:
...
def get_items(filters, additional_table_columns, branch=None):
